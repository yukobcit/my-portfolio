...
export default function Home() {
  return (
    <main
      className={`flex min-h-screen flex-col items-center justify-between p-24 ${inter.className} md:p-0`}
    >
      <div className="about">
        ...
        <div className="flex flex-wrap justify-center md:justify-start text-center mb-20">
